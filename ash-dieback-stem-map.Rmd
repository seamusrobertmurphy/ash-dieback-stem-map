...
las_tile_chm = readLAS("/media/seamus/USB1/Shavington/clouda340d379a59ddadf.las", select = 'xyzcr', filter = '-drop_class 19')
plot(las_tile_chm)
```
...
las_tile = readLAS("/media/seamus/USB1/Shavington/lead_htop_raster.tif", select = 'xyzcr', filter = '-drop_class 19')
